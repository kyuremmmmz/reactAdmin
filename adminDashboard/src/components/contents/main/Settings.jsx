                                    ...
                                    <Row>
                                        <Col>
                                            <Form.Group controlId="formPassword">
                                                ...
                                                <Form.Control type="password" placeholder="Enter new password" className="input-password" />
                                            </Form.Group>
                                            <Form.Group controlId="formRecovery">
                                                <Form.Label className="label-recovery">Account Recovery</Form.Label>
                                                <Form.Control type="text" placeholder="Enter recovery info" className="input-recovery" />
                                            </Form.Group>
                                            <Button variant="primary" className="save-account">Save Account Settings</Button>
                                        </Col>
                                    </Row>
                                </div>
                            )}
